...
parser.add_argument('--preprocess_questions_for', default='train', type=str,
                    help='Please provide in the type of dataset for which you'
                         ...
                         'train, val and test.')
parser.add_argument('--input_questions_json', default=None, type=str)
...
if __name__ == '__main__':
    ...
    if args.preprocess_questions_for == 'train':
        args.input_questions_json = \
            '../../clevr-dataset-gen/output/train/CLEVR_questions.json'
        args.output_h5_file = '../output/questions/train_questions.h5'
    elif args.preprocess_questions_for == 'val':
        args.input_questions_json = \
            '../../clevr-dataset-gen/output/val/CLEVR_questions.json'
        args.output_h5_file = '../output/questions/val_questions.h5'
        args.input_vocab_json = '../output/vocab.json'
    elif args.preprocess_questions_for == 'test':
        args.input_questions_json = \
            '../../clevr-dataset-gen/output/test/CLEVR_questions.json'
        args.output_h5_file = '../output/questions/test_questions.h5'
        args.input_vocab_json = '../output/vocab.json'
